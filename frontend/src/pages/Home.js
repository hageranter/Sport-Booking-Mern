        ...
        <div className="min-h-screen bg-neutral-50 flex items-center justify-center px-4">
          <div className="text-center max-w-xl">
            ...
            <div className="flex justify-center space-x-4">
              <button onClick={() => navigate('/login')} className="px-8 py-3 text-neutral-700 font-semibold hover:text-primary-600 transition-colors">
                Login
              </button>
              <button onClick={() => navigate('/register')} className="px-8 py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors font-semibold shadow-sm flex items-center space-x-2">
                <span>Sign Up</span>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-1 flex items-center">
              <div className="flex-1 flex items-center space-x-3 px-5">
                ...
                <input
                  ...
                  onKeyPress={(e) => {
                    if (e.key === 'Enter') navigate(`/search?q=${searchQuery}`);
                  }}
                />
              </div>
              <button 
