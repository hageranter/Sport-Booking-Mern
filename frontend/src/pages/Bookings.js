...
const Bookings = () => {
  const bookings = [
    { id: 1, court: 'El Ahly Club', date: 'Jan 25, 2026', time: '6:00 PM - 8:00 PM', status: 'Confirmed', qrCode: 'QR123' },
    { id: 2, court: 'Cairo Stadium', date: 'Jan 26, 2026', time: '7:00 PM - 9:00 PM', status: 'Pending', qrCode: 'QR124' },
    { id: 3, court: 'Sporting Club', date: 'Jan 20, 2026', time: '5:00 PM - 7:00 PM', status: 'Completed', qrCode: 'QR122' },
  ];
